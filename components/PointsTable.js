...
function PointsTable() {
  ...
  return (
    <div className="h-full w-2/5 mr-2">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-800 text-white  my-1 mx-auto pt-6">
        ...
        <div className="w-full flex justify-center">
          <button className="bg-yellow-600 p-2 font-bold text-xl mt-1 mb-3 mx-auto rounded">View Full table</button>
        </div>
      </div>
    </div>
  );
