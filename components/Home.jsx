...
function HomePage() {
  return (
    <div className="flex flex-col justify-center items-center md:w-11/12 md:mx-auto font-extrabold">
      ...
      <div className="mb-4 mmnct-about md:mx-auto md:text-xl xl:text-2xl md:rounded-lg">
        <p className="font-normal w-full px-2 text-justify bg-white rounded-lg py-8 shadow-lg md:shadown-xl  ">
          ...
          passed away due to dengue fever. He was a cricket aficionado and loved
          the game to his death.
          <strong>
