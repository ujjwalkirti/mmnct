  ...
  return (
    <div>
      ...
      <p className="text-center">
        (Tap on any one of the matches for whom you wish to win)
      </p>
      <div>
        <ShowMatch />
        <ShowMatch />
...
function ShowMatch() {
  ...
  const teamStyle =
    "text-white flex flex-col text-white justify-evenly items-center text-lg w-1/2 my-5";
  ...
  return (
    <div
      ...
      className="flex bg-gray-200 mx-2 flex-col  my-4 rounded-xl shadow-lg "
    >
      <div className="flex mx-2 bg-gradient-to-br from-yellow-400 via-orange-400 to-orange-600 my-4 rounded-xl shadow-lg ">
        {/* team 1 details */}
      ...
      {/* modal for voting */}
      {showModal && (
        <div className="bg-opacity-70 relative w-auto bg-gray-300">
          <FaWindowClose onClick={handleClose} className="absolute top-0 right-0" />
          <div className="bg-white px-4 py-2 h-full"></div>
        </div>
      )}
    </div>
  );
